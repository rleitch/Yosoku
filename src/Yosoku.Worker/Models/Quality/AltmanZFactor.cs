...
//        decimal currentAssets = bs.TotalCurrentAssets ?? 0;
//        decimal currentLiabilities = bs.TotalCurrentLiabilities ?? 0;
//        decimal wc = currentAssets - currentLiabilities;

//        // 2. Calculate Book Value of Equity (BVE)
//        // BVE = Total Shareholder Equity - Total Liabilities
//        decimal totalLiabilities = bs.TotalLiabilities ?? 0;
//        decimal bve = bs.TotalShareholderEquity.Value;

//        // 3. Apply Altman Z Formula:
//        // 6.56*WC/TA + 3.26*RE/TA + 6.72*EBIT/TA + 1.05*BVE/TL

//        // Term 1: Working Capital Ratio
//        decimal term1 = (wc / bs.TotalAssets.Value) * 6.56;

//        // Term 2: Retained Earnings to Total Assets Ratio
//        decimal retainedEarnings = bs.RetainedEarnings ?? 0;
//        decimal term2 = (retainedEarnings / bs.TotalAssets.Value) * 3.26;

//        // Term 3: EBIT to Total Assets Ratio
//        decimal term3 = (IS.Ebit.Value / bs.TotalAssets.Value) * 6.72;

//        // Term 4: Book Value of Equity to Total Liabilities Ratio
//        decimal term4 = (bve / totalLiabilities) * 1.05;

//        // Final Z Score
//        decimal zScore = term1 + term2 + term3 + term4;
